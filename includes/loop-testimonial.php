...
<article itemscope itemtype="http://schema.org/Article" id="testimonial-<?php the_ID(); ?>" <?php post_class('post clearfix testimonial-post'); ?> data-thumb="<?php echo $testimonial_thumb; ?>" data-thumbw="<?php echo $themify->width; ?>" data-thumbh="<?php echo $themify->height; ?>">
